            ...
            return AnimationConfiguration.staggeredList(
              ...
              child: FlipAnimation(
                child: FadeInAnimation(
                  child: Padding(
                    padding:  EdgeInsets.symmetric(vertical: screenHeight*.000001),
                    child: Container(
                      margin:  EdgeInsets.only(bottom: screenHeight*.05, right: screenWidth*.01),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: TextStyle(
                                color: Colors.white, fontSize: screenWidth * 0.05, fontWeight: FontWeight.bold),
                          ),
                          SizedBox(
